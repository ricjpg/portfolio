...
-- Azure Entra ID (configuración de tenants, grupos, aplicaciones)
...
-- Power BI (configuración de workspaces y permisos)
...
-- Diferentes equipos (InfoSec vs DevOps) gestionan estos recursos
...
-- Las regulaciones de privacidad (GDPR, CCPA) afectan toda la capa de datos

-- Los equipos de Data Engineering tienen expertise específico
...
-- Azure Entra ID, políticas de acceso, Key Vault y NSGs trabajan juntos para crear un perímetro de seguridad coherente
...
-- Front Door requiere conocimiento de todos los endpoints backend
...
-- Power BI requiere permisos coordinados con Synapse Analytics
