...
<ol class='text-green-500 font-mono font-bold'>
  ...
  <li>
    {" "}
    [🔗 Repositorio en GitHub de la API](https://github.com/ricjpg/pipeline-cache)
  </li>
  <li>
    {" "}
    [🔗 Repositorio en GitHub de la UI](https://github.com/ricjpg/pipeline-cache)
  </li>
  <li>
    {" "}
    [🔗 Repositorio en GitHub del Azure Function](https://github.com/ricjpg/pipeline-cache)
  </li>
  <li>
    {" "}
    [🔗 Repositorio en GitHub de la Base de datos](https://github.com/ricjpg/pipeline-cache)
  </li>
  <li>
    {" "}
    [🔗 Repositorio en GitHub de la Arquitectura](https://github.com/ricjpg/pipeline-cache)
  </li>
</ol>
</Frame>
```
