...
<br />
Los stats estaban guardados en un dict llamada "stats". La solución fue romper el
diccionario y poner cada stat directamente como una columna separada en la tabla.
Es como si tuvieras una carpeta llamada "Calificaciones" con hojas sueltas adentro.
En lugar de tener la carpeta, sacas cada hoja y las pones directamente sobre el escritorio,
cada una con su propio lugar.
...
<br />
Las abilities eran una lista de elementos complejos (cada ability tenía nombre, si
era oculta, y un número de slot). La solución fue crear múltiples columnas para cada
ability: una columna para el nombre de la primera ability. Luego lo mismo para la
segunda ability, y así sucesivamente.
...
<Frame>
## <p class = "text-3xl font-extrabold">Organización de Columnas</p>
...
## <p class = "text-3xl font-extrabold">Exportación</p>
